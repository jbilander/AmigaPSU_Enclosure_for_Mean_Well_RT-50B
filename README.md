...
Cabling is taken from an old dead Amiga 500 PSU. Also the power switch is reused and a couple of power resistors is added to put a dummy load to satisfy the minimum load requirements stated in the datasheet.

Please read the Legal Disclaimer before doing any electrical work yourself
